        ...
        <div className="min-h-screen bg-background flex flex-col pt-20">
            ...
            <div className="flex-grow container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="bg-card border border-border/50 rounded-2xl p-8 md:p-12 backdrop-blur-sm relative overflow-hidden">
                    ...
                    <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">Meth VTC Terms of Service</h1>
                    ...
                    <div className="space-y-8 text-muted-foreground leading-relaxed">
                        <p>
                            Welcome to Meth VTC, a Virtual Trucking Company ("VTC") operating within TruckersMP and related trucking simulation platforms. Meth VTC connects virtual truckers who share a passion for exploration, convoy events, structured community activities, and professional representation.
                        </p>
                        <p>
                            By joining Meth VTC, using our Discord server, participating in events, or using our booking system and related services, you agree to the following Terms of Service ("ToS"). Please read these terms carefully.
                        </p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">
                                By applying to Meth VTC, joining our Discord server, participating in convoys, or using any Meth VTC-related services (including our event booking system), you agree to comply with and be bound by these Terms of Service.
                            </p>
                            <p>Violation of any terms may lead to warnings, suspension, or permanent removal from Meth VTC.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>Applicants must not have excessive active bans within TruckersMP. Meth VTC reserves the right to assess eligibility based on overall conduct history.</p>
                        </section>

                        <section>
                            <h2 className="text-2xl font-display font-bold text-foreground mb-4 mt-12 pb-2 border-b border-border/50">3. User Conduct</h2>
                            <p className="mb-4">All members agree to follow Meth VTC’s Code of Conduct, including but not limited to:</p>
                            ...
                            <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Representation of Meth VTC</h3>
                            <p>Members must use the official Meth VTC tag and paintjob during public convoys and official events to maintain a professional and unified appearance.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-2">All Meth VTC members must join the official Discord server to:</p>
                            <ul className="list-disc pl-6 space-y-1 mb-6">
                            ...
                            <p>Meth VTC operates primarily through the Discord platform.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-6">Meth VTC regularly hosts convoys and events. Participation is voluntary but encouraged.</p>
                            ...
                            <p className="mb-2">When using Meth VTC’s event booking system:</p>
                            <ul className="list-disc pl-6 space-y-1 mb-6">
                        ...
                        <section>
                            ...
                            <p className="mb-6 font-semibold text-foreground">Meth VTC is not responsible for compromised accounts.</p>

                            <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Ban Accountability</h3>
                            <p>Members are responsible for any bans received on TruckersMP or related platforms. Repeated bans may result in removal from Meth VTC.</p>
                        </section>

                        <section>
                            <h2 className="text-2xl font-display font-bold text-foreground mb-4 mt-12 pb-2 border-b border-border/50">7. Privacy</h2>
                            <p className="mb-2">Meth VTC collects minimal information necessary for operation, including:</p>
                            <ul className="list-disc pl-6 space-y-1 mb-4">
                        ...
                        <section>
                            ...
                            <p className="mb-4">Meth VTC reserves the right to modify or update these Terms of Service at any time.</p>
                        ...
                        <section>
                            ...
                            <p className="mb-6">Members may leave Meth VTC at any time by notifying HR or Leadership.</p>

                            <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Involuntary Termination</h3>
                            <p className="mb-2">Meth VTC reserves the right to remove members who:</p>
                            <ul className="list-disc pl-6 space-y-1 mb-4">
                        ...
                        <section>
                            ...
                            <p className="mb-4">Meth VTC provides a community-based service for entertainment purposes only.</p>
                        ...
                        <section>
                            ...
                            <p className="mb-2">Meth VTC is not liable for:</p>
                            <ul className="list-disc pl-6 space-y-1 mb-4">
                        ...
                        <section>
                            ...
                            <p className="mb-6">For questions regarding these Terms, please contact Meth VTC Leadership through our official Discord server.</p>
                            ...
                            <div className="bg-secondary/50 p-6 rounded-xl border border-border/50">
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li className="flex items-start gap-2">
                                        <span className="text-primary font-bold">•</span>
                                        <span>
                                            <strong>Email:</strong> Send an email to <a href="mailto:htutorial2003@gmail.com" className="text-primary hover:underline">htutorial2003@gmail.com</a>.
                                        </span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="mt-12 pt-8 border-t border-border/50 text-center">
                            <p className="font-semibold text-foreground">
                                By participating in Meth VTC, you acknowledge that you have read, understood, and agreed to these Terms of Service.
                            </p>
                        </div>
                    </div>
                </div>
