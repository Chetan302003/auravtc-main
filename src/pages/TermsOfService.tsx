            ...
            <div className="flex-grow container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="bg-card border border-border/50 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden">
                    ...
                    <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                        Our full Terms of Service documentation is hosted and maintained publicly on our GitHub repository.
                        You can read all the detailed guidelines, rules, and service agreements by visiting the link below.
                    </p>
                    <a
                        href="https://github.com/Chetan302003/AURA-Terms-of-Service"
                        target="_blank"
                    ...
                    >
                        Read Terms of Service <ExternalLink className="w-5 h-5" />
                    </a>
                </div>
            </div>
            <Footer />
