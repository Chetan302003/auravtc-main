                ...
                {(['founder', 'management', 'hr', 'events', 'media', 'member', 'trainee'] as RoleTier[]).map((tierKey) => {
                  ...
                  return (
                    <div key={tierKey} className="mb-8 sm:mb-12 animate-slide-up" style={{ animationDelay: `${0.1 * (['founder', 'management', 'hr', 'member', 'trainee'] as RoleTier[]).indexOf(tierKey)}s` }}>
                      ...
                      <div className={`grid gap-4 sm:gap-6 ${tierMembers.length === 1
                        ...
                        {tierMembers.map((member, index) => {
                          ...
                          return (
                            <a
                              ...
                              className="block h-full group hover:scale-105 hover:-translate-y-2 transition-all duration-500 animate-scale-in"
                              style={{ animationDelay: `${index * 0.08}s` }}
                            >
                              <SpotlightCard className={`h-full glass-card p-4 sm:p-6 text-center ${tierStyles[tier]} hover:shadow-lg ${tierGlow[tier]} flex flex-col items-center`}>
