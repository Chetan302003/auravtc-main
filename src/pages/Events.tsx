            ...
            {!loading && !error && events.length > 0 && (
              <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                {events.map((event, index) => (
                  <SpotlightCard
                    key={event.id}
                    className="group glass-card rounded-2xl overflow-hidden hover:border-primary/50 transition-all duration-500 hover:glow-border animate-slide-up flex flex-col hover:-translate-y-2 p-0"
