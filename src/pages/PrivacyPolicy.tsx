        ...
        <div className="min-h-screen bg-background flex flex-col pt-20">
            ...
            <div className="flex-grow container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="bg-card border border-border/50 rounded-2xl p-8 md:p-12 backdrop-blur-sm relative overflow-hidden">
                    ...
                    <h1 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-4">Meth VTC Privacy Policy</h1>
                    ...
                    <div className="space-y-8 text-muted-foreground leading-relaxed">
                        <p>
                            Meth VTC ("we," "our," or "us") respects your privacy and is committed to protecting any personal information we collect. This Privacy Policy explains what information we collect, how we use it, and how you can control your personal information in connection with your participation in Meth VTC and its associated services, including our Discord server and booking system.
                        </p>
                        <p>
                            By joining Meth VTC and engaging in our activities, you agree to the collection and use of information in accordance with this Privacy Policy.
                        </p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">To manage and support Meth VTC community activities, we may collect the following types of information:</p>
                            ...
                            <p className="mb-2">When using the Meth VTC event booking system, we may store:</p>
                            <ul className="list-disc pl-6 space-y-1 mb-6">
                            ...
                            <ul className="list-disc pl-6 space-y-1">
                                ...
                                <li>Activity within Meth VTC events</li>
                        ...
                        <section>
                            ...
                            <p className="mb-6">We use your information solely to operate and improve the Meth VTC experience. Specifically, we may use your information for:</p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">Meth VTC does not sell, trade, or transfer your personal information to outside parties. We may share information only in the following limited circumstances:</p>

                            <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Service Providers</h3>
                            <p className="mb-2">We may use trusted third-party services necessary to operate Meth VTC, such as:</p>
                            <ul className="list-disc pl-6 space-y-1 mb-6">
                            ...
                            <p>We may disclose information if required by law, court order, or governmental authority, or to protect the rights, safety, and integrity of Meth VTC and its community.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 space-y-1 mb-6">
                                <li>Operate Meth VTC services</li>
                        ...
                        <section>
                            ...
                            <p className="mb-4">You may request access to or correction of your information by contacting Meth VTC Leadership.</p>

                            <h3 className="text-xl font-semibold text-foreground mt-6 mb-2">Opt-Out</h3>
                            <p className="mb-4">Participation in Meth VTC is voluntary. You may leave the community at any time.</p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">Meth VTC may integrate with third-party services related to trucking simulation platforms and community tools. These external platforms operate under their own privacy policies. Meth VTC is not responsible for their data practices.</p>
                        ...
                        <section>
                            ...
                            <p className="mb-4">Meth VTC may update this Privacy Policy from time to time to reflect changes in our practices or services.</p>
                            ...
                            <p>Continued participation in Meth VTC after such updates constitutes acceptance of the revised Privacy Policy.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-6">If you have any questions, concerns, or data requests regarding this Privacy Policy, please contact Meth VTC Leadership through our official Discord server.</p>
                        ...
                        <div className="mt-12 pt-8 border-t border-border/50 text-center">
                            <p className="font-semibold text-foreground">
                                By participating in Meth VTC, you acknowledge that you have read, understood, and agreed to this Privacy Policy.
                            </p>
                        </div>
                    </div>
                </div>
