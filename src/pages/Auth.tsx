  ...
  const OAuthButtons = () => (
    <div className="space-y-3">
      ...
      <p className="text-center text-xs text-muted-foreground mt-4">
        By signing in or continuing, you agree to our <a href="/terms-of-service" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Terms of Service</a> and <a href="/privacy-policy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Privacy Policy</a>.
      </p>
    </div>
  );
                  ...
                  <div className="flex items-start space-x-3 mt-4 mb-2">
                    <div className="flex items-center h-5">
                      <input
                        ...
                        className="w-4 h-4 rounded border-border/50 text-primary focus:ring-primary/20 bg-secondary/50 accent-primary"
                      />
                    </div>
                    <Label htmlFor="terms" className="text-sm font-normal text-muted-foreground leading-snug cursor-pointer">
                      I agree to the <a href="/terms-of-service" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Terms of Service</a> and <a href="/privacy-policy" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
                    </Label>
                  </div>
