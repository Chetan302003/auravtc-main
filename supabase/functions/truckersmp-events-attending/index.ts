...
serve(async (req) => {
  ...
  try {
    console.log('Fetching TruckersMP attending events...');
    
    // Use the attending events API endpoint
    ...
    console.log('Raw attending events data:', JSON.stringify(data).substring(0, 500));
